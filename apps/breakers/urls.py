...
urlpatterns = [
    ...
    path('statuses/', views.BreakerStatusListView.as_view(), name='breaker-status-list'),
    path('statuses/<str:device_id>/', views.BreakerStoredStatusView.as_view(), name='breaker-status-stored'),
    path('readings/', views.BreakerReadingListView.as_view(), name='breaker-reading-list'),
    ...
    path('<str:device_id>/readings/', views.BreakerReadingListView.as_view(), name='breaker-reading-history'),
